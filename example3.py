...
if __name__ == "__main__":
    ...
    # adding the new slice
    info("*** Adding Host for open5gs UPF TEST\n")
    env["COMPONENT_NAME"]="upf_test"
    upf_test = net.addDockerHost(
        "upf_test",
        dimage="my5gc_v2-4-4",
        #changed ip
        ip="192.168.0.114/24",
    ...
    net.addLink(upf_test, s2, bw=1000, delay="1ms", intfName1="upf_test-s2", intfName2="s2-upf_test")
